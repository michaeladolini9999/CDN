...
# Đường dẫn đến thư mục override của openresty
OVERRIDE_DIR="/etc/systemd/system/openresty.service.d"
OVERRIDE_FILE="${OVERRIDE_DIR}/override.conf"
HEADER="### Editing /etc/systemd/system/openresty.service.d/override.conf"
...
# Reload cấu hình systemd và restart openresty để thay đổi có hiệu lực
echo "Reload cấu hình systemd..."
sudo systemctl daemon-reload
...
echo "Đã cập nhật override file cho openresty tại $OVERRIDE_FILE"
